...
class TambahSupplier extends StatefulWidget {
  ...
  @override
  State<TambahSupplier> createState() => Tambah_SupplierState();
}

class Tambah_SupplierState extends State<TambahSupplier> {
  ...
  Future<void> tambahSupplier() async {
    try {
      Uri url = Uri.parse(BaseUrl.url + '/tambahsupplier');
